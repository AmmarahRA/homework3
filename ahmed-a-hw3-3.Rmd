...
The regression shows that cigarette demand has an elasticity of `r round(reg6$coefficients[2],3)` , which is inelestic, suggesting that cigarette demand is less responsive to changes in price.
...
The IV regression shows that cigarette demand has a price elasticity of `r round(iv7$coefficients[2],3)` which is inelastic. However, it is more inelastic compared to the previous regression without an instrument, suggesting that demand is even less responsive to price changes.
